...
class CodeSolveQuestionJavaScript extends StatefulWidget {
  const CodeSolveQuestionJavaScript({super.key});

  @override
  State<CodeSolveQuestionJavaScript> createState() =>
      _CodeSolveQuestionJavaScriptState();
}

class _CodeSolveQuestionJavaScriptState
    extends State<CodeSolveQuestionJavaScript> {
